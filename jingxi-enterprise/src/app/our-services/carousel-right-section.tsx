...
export const CarouselRightSection = ({
  title,
  description,
  images,
}: {
  ...
  return (
    <section className="flex h-[600px] w-full mb-8 relative overflow-hidden">
      <div
        className={`flex w-full transition-all duration-500 ${
          isExpanded ? "lg:flex-row" : ""
        }`}
      >
        {/* Left Side - hidden when expanded on mobile */}
        <div
          className={`flex-none bg-teal-50 flex flex-col item-start justify-center lg:text-left h-[600px] ${
        ...
        {/* Right Side - expands to full width on mobile when expanded */}
        <div
